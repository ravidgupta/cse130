...
struct file_entry
{
   ...
   struct file *file_ptr;        // Pointer to opened file
   struct list_elem file_elem;    // Required for oft list in thread struct
};
...
struct thread {
   ...
   uint8_t *current_esp;  // "Executable Stack Pointer" i.e the current 
                          // value of the user program’s stack pointer
